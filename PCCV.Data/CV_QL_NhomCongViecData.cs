...
namespace Uneti.Data
{
    public class CV_QL_NhomCongViecData
    {
        ...
        public int CV_QL_NhomCongViec_Del(CV_QL_NhomCongViecPublic Public)
        {
            ...
            return cls.Update("SP_CV_QL_NhomCongViec_Del", bien, giatri, thamso);
        }
        // Thêm công việc 
        public int CV_QL_NhomCongViec_Add(CV_QL_NhomCongViecPublic Public)
        {
            ...
            return cls.Update("SP_CV_QL_NhomCongViec_Insert", bien, giatri, thamso);
        }
        // Sửa công việc
        public int CV_QL_NhomCongViec_Edit(CV_QL_NhomCongViecPublic Public)
        {
            ...
            return cls.Update("SP_CV_QL_NhomCongViec_Update", bien, giatri, thamso);
        }
    }
}
