...
namespace Uneti.Online.form.PhanCong
{
    public partial class frmCV_PC_PhanCongCongViecNhanSu : Form
    {
        ...
        CV_PC_PhanCongCongViecNhanSuPublic UnetiPublic = new CV_PC_PhanCongCongViecNhanSuPublic();
            ...
            for (int i = 0; i < roundCV; i++)
            {
                for (int j = 0; j < roundNS; j++)
                {
                    ...
                    if (NhomThucHienCongViec != null && nhomThucHienNhanSu != null && KhaNangChuyenMonNhanSu != null && KhaNangChuyenMonCongViec!=null)
                    {
                        ...
                        {
                            UnetiPublic.CV_PC_PhanCongCongViecNhanSu_IDCongViec = Convert.ToInt32(dtCongViec.Rows[i]["CV_QL_CongViec_ID"].ToString());
                            UnetiPublic.CV_PC_PhanCongCongViecNhanSu_IDUser = Convert.ToInt32(dtNhanSu.Rows[j]["CV_QL_NhanSu_ID"].ToString());
                    ...
                    //{
                    //    UnetiPublic.CV_PC_PhanCongCongViecNhanSu_HienThi = true;
                    //    UnetiPublic.CV_PC_PhanCongCongViecNhanSu_SuDung = BienToanCuc.HT_USER_Ten;
                    //    UnetiPublic.CV_PC_PhanCongCongViecNhanSu_IDCongViec = Convert.ToInt32(dtCongViec.Rows[i]["CV_QL_CongViec_ID"].ToString());
                    //    UnetiPublic.CV_PC_PhanCongCongViecNhanSu_IDUser = Convert.ToInt32(dtNhanSu.Rows[j]["CV_QL_NhanSu_ID"].ToString());
                    //    CV_PC_PhanCongCongViecNhanSu_bandedGridView.AddNewRow();
                    //}
        ...
        private void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                if (Convert.ToBoolean(CV_PC_PhanCongCongViecNhanSu_bandedGridView.GetFocusedRowCellValue(CV_PC_PhanCongCongViecNhanSuChon))) // == true
                {
                    ...
                    UnetiPublic.CV_PC_PhanCongCongViecNhanSu_HienThi = true;
                    UnetiPublic.CV_PC_PhanCongCongViecNhanSu_SuDung = BienToanCuc.HT_USER_Ten;
                    UnetiPublic.CV_PC_PhanCongCongViecNhanSu_IDCongViec = Convert.ToInt32(CV_PC_PhanCongCongViecNhanSu_bandedGridView.GetFocusedRowCellValue(CV_PC_PhanCongCongViecNhanSu_TenCongViec));
                    UnetiPublic.CV_PC_PhanCongCongViecNhanSu_IDUser = Convert.ToInt32(CV_PC_PhanCongCongViecNhanSu_bandedGridView.GetFocusedRowCellValue(CV_PC_PhanCongCongViecNhanSu_IDUser));
                    UnetiPublic.CV_PC_PhanCongCongViecNhanSu_IDVaiTro = Convert.ToInt32(CV_PC_PhanCongCongViecNhanSu_bandedGridView.GetFocusedRowCellValue(CV_PC_PhanCongCongViecNhanSu_IdVaiTro));
                    if (!string.IsNullOrWhiteSpace(Convert.ToString(CV_PC_PhanCongCongViecNhanSu_bandedGridView.GetFocusedRowCellValue(CV_PC_PhanCongCongViecNhanSu_DanhGia))))
                    {
                        UnetiPublic.CV_PC_PhanCongCongViecNhanSu_DanhGia = CV_PC_PhanCongCongViecNhanSu_bandedGridView.GetFocusedRowCellDisplayText(CV_PC_PhanCongCongViecNhanSu_DanhGia);
                    }
                    UnetiPublic.CV_PC_PhanCongCongViecNhanSu_DiaDiemThucHien = CV_PC_PhanCongCongViecNhanSu_bandedGridView.GetFocusedRowCellDisplayText(CV_PC_PhanCongCongViecNhanSu_DiaDiemThucHien);
                    if (!string.IsNullOrWhiteSpace(Convert.ToString(CV_PC_PhanCongCongViecNhanSu_bandedGridView.GetFocusedRowCellValue(CV_PC_PhanCongCongViecNhanSu_LyDo))))
                    {
                        UnetiPublic.CV_PC_PhanCongCongViecNhanSu_LyDo = CV_PC_PhanCongCongViecNhanSu_bandedGridView.GetFocusedRowCellDisplayText(CV_PC_PhanCongCongViecNhanSu_LyDo);
                    }
                    CV_PC_PhanCongCongViecNhanSu_bandedGridView.AddNewRow();
        ...
        {
            CV_PC_PhanCongCongViecNhanSu_bandedGridView.SetRowCellValue(e.RowHandle, CV_PC_PhanCongCongViecNhanSu_bandedGridView.Columns["CV_PC_PhanCongCongViecNhanSu_IDCongViec"], UnetiPublic.CV_PC_PhanCongCongViecNhanSu_IDCongViec);
            CV_PC_PhanCongCongViecNhanSu_bandedGridView.SetRowCellValue(e.RowHandle, CV_PC_PhanCongCongViecNhanSu_bandedGridView.Columns["CV_PC_PhanCongCongViecNhanSu_IDUser"], UnetiPublic.CV_PC_PhanCongCongViecNhanSu_IDUser);
            CV_PC_PhanCongCongViecNhanSu_bandedGridView.SetRowCellValue(e.RowHandle, CV_PC_PhanCongCongViecNhanSu_bandedGridView.Columns["CV_PC_PhanCongCongViecNhanSu_IdVaiTro"], UnetiPublic.CV_PC_PhanCongCongViecNhanSu_IDVaiTro);
            CV_PC_PhanCongCongViecNhanSu_bandedGridView.SetRowCellValue(e.RowHandle, CV_PC_PhanCongCongViecNhanSu_bandedGridView.Columns["CV_PC_PhanCongCongViecNhanSu_DanhGia"], UnetiPublic.CV_PC_PhanCongCongViecNhanSu_DanhGia);
            CV_PC_PhanCongCongViecNhanSu_bandedGridView.SetRowCellValue(e.RowHandle, CV_PC_PhanCongCongViecNhanSu_bandedGridView.Columns["CV_PC_PhanCongCongViecNhanSu_LyDo"], UnetiPublic.CV_PC_PhanCongCongViecNhanSu_LyDo);
            CV_PC_PhanCongCongViecNhanSu_bandedGridView.SetRowCellValue(e.RowHandle, CV_PC_PhanCongCongViecNhanSu_bandedGridView.Columns["CV_PC_PhanCongCongViecNhanSu_DiaDiemThucHien"], UnetiPublic.CV_PC_PhanCongCongViecNhanSu_DiaDiemThucHien);
